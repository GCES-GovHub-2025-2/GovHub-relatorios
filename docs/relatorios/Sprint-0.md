...
| Gabriel Reis Scheidt Paulino            | Estudo do repositório GovHub-br, investigação da arquitetura Medallion e setup do ambiente Docker local                                                                                                                              | [Repositório GovHub-br](https://github.com/GovHub-br/data-application-gov-hub)                                                                                                | Foco em compreensão da arquitetura e configuração do ambiente                                 |
